...
const AdminDashboard = () => {
  ...
  /* ── Render content area based on activeNav �      /* ── DOCTORS MANAGEMENT ── */
      case 'doctors':
        return (
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {filteredDoctorsList.map(doc => (
                      <tr key={doc.id} className="hover:bg-blue-50/50 transition-colors group">
                        ...
                        <td className="px-5 py-4">
                          <span className="text-base font-bold uppercase tracking-wider text-teal-700 bg-teal-50 border border-teal-100 px-2.5 py-1 rounded-md flex items-center gap-1 w-max">
                            <Stethoscope className="w-3 h-3" /> {doc.specialty}
                          </span>
                        </td>
                        <td className="px-5 py-4 text-base font-bold text-slate-705">{doc.experience}</td>
                        ...
                        <td className="px-5 py-4">
                          <div className="flex gap-2">
                            <button className="w-8 h-8 rounded-lg border border-[#E2E8F0] text-outline hover:text-secondary hover:border-teal-200 hover:bg-teal-50 flex items-center justify-center transition-all shadow-level-1">
  ...
  return (
    <div className="min-h-screen bg-surface-container-low flex font-sans text-blue-950">
